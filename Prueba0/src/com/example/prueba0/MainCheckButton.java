...
public class MainCheckButton extends Activity {
		...
		chkIos.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (((CheckBox) v).isChecked()) {
					Toast.makeText(MainCheckButton.this,
							"no te gusta más Android ? :)", Toast.LENGTH_LONG).show();
				}
	...
	public void addListenerOnButton() {
		...
		btnDisplay.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(MainCheckButton.this, result.toString(),
